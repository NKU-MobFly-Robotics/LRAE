...
int main(int argc, char** argv)
{
  ...
  ros::Publisher pubSpeed = nh.advertise<geometry_msgs::TwistStamped> ("/cmd_vel2", 5);
  geometry_msgs::TwistStamped cmd_vel;
  cmd_vel.header.frame_id = "vehicle";

  ros::Publisher pubSpeedG = nh.advertise<geometry_msgs::Twist> ("/cmd_vel", 5);
  geometry_msgs::Twist cmd_velG;
