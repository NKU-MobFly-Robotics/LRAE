...
def listener():
  ...
  rospy.Subscriber("/ExplorationTime", Float32, timeDurationCallback)
  rospy.Subscriber("/runtime", Float32, runTimeCallback)
  rospy.Subscriber("/exploredVolume", Float32, exploredVolumeCallback)
  rospy.Subscriber("/PathLen", Float32, travelingDistanceCallback)
